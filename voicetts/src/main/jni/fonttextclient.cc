...
#include <string.h>
#include <assert.h>
#include "com_gykj_voicetts_CalcMac.h"
...
JNIEXPORT void JNICALL Java_com_gykj_voicetts_CalcMac_Native_1Jni(JNIEnv *env, jclass clazz,jstring text){
...
JNIEXPORT jstring JNICALL Java_com_gykj_voicetts_CalcMac_Native_1JniCalcText(JNIEnv *env, jclass clazz,
                                                                                         jstring text) {
        const char *str_txt= env->GetStringUTFChars(text, NULL);
